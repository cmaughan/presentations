...
- New idea: express the 'done' state as a mathematically proven result
- Research field, but I've seen it used
- https://lean-lang.org/

## Goals

- `/goal make all these audio samples match`
- Great for long term, researchy or a iterative tasks
- In my experience expensive and can wander off...
